...
public class ReceivedEncryptedGroupMessageEvent implements HSMEvent {

    private static final Logger logger = LoggerFactory.getLogger(ReceivedEncryptedGroupMessageEvent.class);
    ...
    public ReceivedEncryptedGroupMessageEvent(byte[] bytes, String encodedMessage, GotrUser user, GotrCrypto crypto) throws IOException {
        this.bytes = bytes;
